    ...
    <div className='container-fluid' id='Roos1'>
        ...
        <div className='col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-12'>
            ...
            <div className='col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-12'>
                <div className='room-box'>
                <div className='living-spaces .overlay'>
                     <img src={horizonpic2} alt='' className='loghousepick0' />
                     </div>
                     <div className='room-detail'>
                        <h4>Living Room</h4>
        ...
        <div className='col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-12'>
            ...
            <div className='col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-12'>
                <div className='room-box'>
                <div className='living-spaces .overlay'>
                     <img src={Silvertonpic3} alt='' className='loghousepick0' />
                     </div>
                     <div className='room-detail'>
                        <h4>Sit Out Area</h4>
        ...
        <div className='col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-12'>
            ...
            <div className='col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-12'>
                <div className='room-box'>
                <div className='living-spaces .overlay'>
                     <img src={ElevenOakspic4} alt='' className='loghousepick0' />
                     </div>
                     <div className='room-detail'>
                        <h4>Cottages</h4>
        ...
        <div className='col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-12'>
            ...
            <div className='col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-12'>
                ...
                <div className='living-spaces .overlay'>
                     ...
                     <div className='room-detail'>
                        <h4>Kitchen</h4>
                      <p className='established'>The kitchen is furnished with a microwave, gas stove, refrigerator, water purifier and toaster. Crockery and high-quality cutlery and crockery to meet your culinary needs. </p>
                      <p className='detailed'><a href='/hotels/65ae1919080be1af8bef07ad'>Read More</a></p>
                     </div>
                </div>
            </div>
            <div className='col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-12'>
                <div className='room-box'>
                <div className='living-spaces .overlay'>
                     <img src={sicottagepick1} alt='' className='loghousepick0' />
                     </div>
                     <div className='room-detail'>
                        <h4>Living Area</h4>
